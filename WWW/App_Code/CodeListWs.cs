...
public class CodeListWS : System.Web.Services.WebService
{
    ...
    {
        return CodeManagementBll.Instance.InsertCodeList(code, name, segment, account, effectiveDate, requester, status, field, type);
    }
    ...
    {
        return CodeManagementBll.Instance.UpdateCode(codeId, code, name, segment, account, effectiveDate, requester, status, field, type);
    }
