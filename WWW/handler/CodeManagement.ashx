<%@ WebHandler Language="C#" Class="CodeManagement" %>
...
public class CodeManagement : IHttpHandler, IReadOnlySessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        switch (type)
        {
            case "GetOverviewCodeManagement":
                GetOverviewCodeManagement(context);
                break;
    ...
    public void GetOverviewCodeManagement(HttpContext context)
    {
        string account = context.Request.QueryString["account"] ?? "";
        string json = Newtonsoft.Json.JsonConvert.SerializeObject(CodeManagementBll.Instance.GetOverviewCodeManagement(account));
        context.Response.Write(json);
    }
