...
public partial class pages_charts_SalesProductivity_vi : System.Web.UI.Page
{
    ...
    protected void GetChartProductivity()
    {
        ...
        Series series1 = new Series("Cho vay", ViewType.Spline);
        ...
        Series series2 = new Series("Huy động", ViewType.Spline);
        ...
        GetChartTitle(chartProductivity, "Năng Suất Bán",
    ...
    public void GetChartBranchVsAC()
    {
        ...
        Series series1 = new Series("Chi nhánh", ViewType.Spline);
        series1.DataSource = obj1;
        series1.ArgumentDataMember = "Month";
        series1.ValueDataMembers[0] = "Amount";
        series1.ArgumentScaleType = ScaleType.Auto;
        ...
        Series series2 = new Series("Kênh thay thế", ViewType.Spline);
        series2.DataSource = obj2;
        series2.ArgumentDataMember = "MONTH";
        series2.ValueDataMembers[0] = "Amount";
        series2.ArgumentScaleType = ScaleType.Auto;
        ...
        GetChartTitle(chart1, "Vay mua ô tô",
            ChartTitleDockStyle.Top, true, "Arial", 12, FontStyle.Bold, Color.FromArgb(49, 134, 172), 10);
        ...
        series1 = new Series("Chi nhánh", ViewType.Spline);
        series1.DataSource = obj1;
        series1.ArgumentDataMember = "Month";
        series1.ValueDataMembers[0] = "Amount";
        series1.ArgumentScaleType = ScaleType.Auto;
        ...
        series2 = new Series("Kênh thay thế", ViewType.Spline);
        series2.DataSource = obj2;
        series2.ArgumentDataMember = "MONTH";
        series2.ValueDataMembers[0] = "Amount";
        series2.ArgumentScaleType = ScaleType.Auto;
        ...
        GetChartTitle(chart2, "Vay mua nhà",
            ChartTitleDockStyle.Top, true, "Arial", 12, FontStyle.Bold, Color.FromArgb(49, 134, 172), 10);
        ...
        GetChartTitle(chart3, "Vay kinh doanh",
            ChartTitleDockStyle.Top, true, "Arial", 12, FontStyle.Bold, Color.FromArgb(49, 134, 172), 10);
        ...
        GetChartTitle(chart4, "Vay tiêu dùng",
            ChartTitleDockStyle.Top, true, "Arial", 12, FontStyle.Bold, Color.FromArgb(49, 134, 172), 10);
