...
public partial class pages_charts_WeeklyCeoDashboard : System.Web.UI.Page
{
    public string date
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            //ComboBoxHelper.PrepareComboBox(cbSegment, new string[] { "Top", "Top Inside", "Center", "Bottom Inside" });
