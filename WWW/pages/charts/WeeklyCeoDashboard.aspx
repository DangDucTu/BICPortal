<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="WeeklyCeoDashboard.aspx.cs" Inherits="pages_charts_WeeklyCeoDashboard" %>
    ...
    <div class="dashboard ceo-weekly-dashboard">
        ...
        <div class="box summary">
            ...
            <table style="width: 10%">
                <tr>
                    <th colspan="2" style="color: #C00000; padding: 8px; background: #E8E8E8;">&nbsp;</th>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <tr><td style="text-align: left; padding-left: 10px; font-size: 13px;"><strong>RETAIL</strong></td></tr>
                <tr><td style="text-align: left; padding-left: 10px; font-size: 13px;"><strong>SME</strong></td></tr>
            </table>
            <table>
                <tr>
            ...
            <table>
                <tr>
                    <th colspan="2" style="color: #C00000; padding: 8px; background: #E8E8E8; font-size: 14px;">
                        SALES PRODUCTIVITY (Billion/Salesman)
                    </th>                    
                </tr>
                <tr>
                    <td style="font-weight: bold; font-style: italic; font-size: 15px;">
