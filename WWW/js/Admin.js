...
pages_Admin = {
    htmlTag: {
        ...
        spanTotalRecord: '#spanTotalRecord',
    ...
    pagging: new VtcPaging('divPaging', 'pages_Admin.bindData', 'pagingCss', 20, 10),
    ...
    bindData: function (currentPage) {
        var pageSize = parseInt($(this.htmlTag.selPagesize).val(), 10);
        this.pagging.pageSize = pageSize;

        $(pages_Admin.htmlTag.checkAll).attr('checked', false);
        ...
        this.objSearch.documentReady();

        pages_Admin.processCheckAll();
        pages_Admin.processCheckItem();
    },

    objSearch: new Pages_Search_Global(
        [],
        [],
        "/handler/AdminHandler.ashx",
        "AdminGetList",
        "#tbList",
        "/templates/pages/lstAdmin.htm?t=1",
        null,
        "pages_Category.objSearch"
    ),
